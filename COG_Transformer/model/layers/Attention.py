...
import numpy as np
from model.layers.EDL import EncoderLayer, DecoderLayer
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask=None):
        ...
        output = self.output_linear(attended)[:B]
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, memo2, tgt_mask=None, memory_mask=None):
        ...
        tgt4 = self.feed_forward_norm(tgt3 + self.dropout(self.feed_forward(tgt3)))[:memory.size(0)]
